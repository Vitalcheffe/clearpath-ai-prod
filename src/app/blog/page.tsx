...
const articles: BlogArticle[] = [
  ...
  },
  {
    ...
    author: 'Amine Harch El Korane',
    authorRole: 'Co-Founder, AI Pipeline Lead',
    authorInitials: 'AH',
...
const communityStories = [
  ...
  {
    name: 'Designed scenario (hypothetical family)',
    role: 'Illustrative — not a real testimonial',
    story: 'Hypothetical scenario designed to show how ClearPath AI would handle a family needing food assistance with language barriers. ClearPath AI would classify their need and highlight a food bank with Mandarin-speaking volunteers. We have not piloted this with real families yet.',
    avatar: 'from-amber-400 to-orange-500',
    initials: 'DS',
    tag: 'Food Access',
  },
  {
    name: 'Designed scenario (hypothetical survivor)',
    role: 'Illustrative — not a real testimonial',
    story: 'Hypothetical scenario designed to show the privacy-first design. ClearPath AI would process this query without storing any personal information and connect the user with a confidential crisis counselor. We have not piloted this with real survivors yet.',
            ...
            >
              {[
                ...
                },
                {
                  ...
                  description: 'The 6-layer transparency architecture is formalized. Amine Harch El Korane joins to lead AI research. The decision to use BART-large-MNLI is made.',
                  icon: Workflow,
                  color: '#8b5cf6',
                },
                {
                  ...
                  description: 'Amine Harch El Korane engineers the dual-layer crisis detection system. Technical documentation of the dual-layer approach is written.',
                  icon: Shield,
                  color: '#ef4444',
                },
                {
              ...
              {[
                {
                  ...
                  bio: 'High school student from Morocco. Owns the 6-layer classify pipeline, the 175-pattern crisis regex, and the BART-large-MNLI integration. Wrote the pitch and the Devpost submission.',
                  articleCount: 4,
                  focus: 'AI Pipeline & Pitch',
                },
                {
                  name: 'Amine Harch El Korane',
                  role: 'Co-Founder, AI Pipeline Lead',
                  ...
                  bio: 'Same person, different article set. Architect of the regex crisis detection layer and the 70% confidence gate. Iterated the regex list many times to handle edge cases like "I\'m dying laughing" vs "I\'m dying".',
                  articleCount: 3,
                ...
                },
                {
                  ...
                  bio: 'High school student from Morocco. Built the Next.js API routes, the 3-tier fallback pipeline (raw fetch → HuggingFace SDK → keyword match), the Prisma data layer, and the multi-city resource database covering 6 US cities.',
                  articleCount: 3,
                  focus: 'Full-Stack & Infrastructure',
                },
                {
                  name: 'Ghali El Alj',
                  role: 'Co-Founder, Full-Stack Engineer',
                  ...
                  bio: 'Same person, different article set. Hand-curated the resource database from public 211.org listings, Benefits.gov, HUD, and SAMHSA. Every resource was manually verified in May 2026.',
                  articleCount: 2,
                  focus: 'Data & Deployment',
                },
              ].map((author) => (
                <motion.div
                  key={author.name}
